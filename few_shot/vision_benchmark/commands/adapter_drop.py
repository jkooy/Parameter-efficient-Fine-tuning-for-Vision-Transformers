...
from vision_benchmark.evaluation.adapterdrop import *
...
def main():
    ...
    # Run AdapterDrop finetuning
    logging.info('Finetuning with AdapterDrop.')
    adapterdrop(train_dataloader, val_dataloader, test_dataloader, args.no_tuning, args.lr, args.l2, config)
