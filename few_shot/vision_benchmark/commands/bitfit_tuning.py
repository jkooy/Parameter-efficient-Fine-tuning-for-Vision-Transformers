...
from vision_benchmark.evaluation.bitfit import *
...
def main():
    ...
    # Run bitfit
    logging.info('Finetuning with bitfit.')
    bitfit(train_dataloader, val_dataloader, test_dataloader, args.no_tuning, args.lr, args.l2, config)
