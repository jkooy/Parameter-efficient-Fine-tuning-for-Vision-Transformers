...
from vision_benchmark.evaluation.kadaptation import *
...
def main():
    ...
    # Run kronecker adaptation finetuning
    logging.info('Finetuning with kadaptation.')
    kadapt(train_dataloader, val_dataloader, test_dataloader, args.no_tuning, args.lr, args.l2, config)
