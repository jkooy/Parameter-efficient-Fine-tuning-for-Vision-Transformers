...
class BasicBlock(nn.Module):
    ...
    def __init__(
        self, inplanes, planes, stride=1, downsample=None, with_se=False
    ):
...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self, cfg, **kwargs):
        ...
        self.relu = nn.ReLU(inplace=True)
        self.layer1 = self._build_layer(Bottleneck, 64, 64, 4)
        ...
        #     self.final_layer = self._build_head(num_channels_last)
        head_spec = spec.HEAD
        ...
        self.downsamp_modules = output_modules[1]
    ...
    def _build_head(
        ...
        return incre_modules, downsamp_modules, proj_modules
    ...
    def _build_layer(self, block, inplanes, planes, blocks, stride=1, with_se=False):
        downsample = None
        ...
        for i in range(1, blocks):
            layers.append(block(inplanes, planes, with_se=with_se))
    ...
    def init_weights(self, pretrained='', pretrained_layers=[]):
        logging.info('=> init weights using kaiming fan_out')
