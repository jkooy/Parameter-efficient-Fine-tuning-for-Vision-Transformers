...
from vision_benchmark.evaluation.LePE import *
...
def main():
    ...
    # Run LePE-tuning
    logging.info('Finetuning with LePE-tuning.')
    lepe(train_dataloader, val_dataloader, test_dataloader, args.no_tuning, args.lr, args.l2, config)
