...
from vision_benchmark.evaluation.lora_fix_one import *
...
def main():
    ...
    # Run lorafix finetuning
    logging.info('Finetuning with lora with one matrix.')
    lora_fix(train_dataloader, val_dataloader, test_dataloader, args.no_tuning, args.lr, args.l2, config)
