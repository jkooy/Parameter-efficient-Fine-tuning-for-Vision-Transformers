...
from vision_benchmark.evaluation.transformer_classifier import *
...
def main():
    ...
    # Run transformer-probing
    logging.info('Finetuning with transformer-probing.')
    transformer_classifier(train_dataloader, val_dataloader, test_dataloader, args.no_tuning, args.lr, args.l2, config)
