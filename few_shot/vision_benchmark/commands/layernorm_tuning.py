...
from vision_benchmark.evaluation.layernorm import *
...
def main():
    ...
    logging.info('Finetuning with layernorm-tuning.')
    layernormt(train_dataloader, val_dataloader, test_dataloader, args.no_tuning, args.lr, args.l2, config)
