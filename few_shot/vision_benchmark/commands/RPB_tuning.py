...
from vision_benchmark.evaluation.RPB import *
...
def main():
    ...
    # Run RPB-tuning
    logging.info('Finetuning with RPB-tuning.')
    rpbt(train_dataloader, val_dataloader, test_dataloader, args.no_tuning, args.lr, args.l2, config)
