...
def build_optimizer_different_lr(cfg, model):
    ...
    if cfg.TRAIN.OPTIMIZER == 'sgd':
        optimizer = optim.SGD(
            [
        {'params': model.model.parameters(), 'lr': 0.1, 'weight_decay': cfg.TRAIN.WD},
        {'params': model.layers.parameters(), 'lr': cfg.TRAIN.LR, 'weight_decay': cfg.TRAIN.WD}
         ])
