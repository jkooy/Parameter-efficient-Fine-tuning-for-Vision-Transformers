...
from vision_benchmark.evaluation.adapter import *
...
def main():
    ...
    # Run adapter finetuning
    logging.info('Finetuning with adapter-tuning.')
    adapter(train_dataloader, val_dataloader, test_dataloader, args.no_tuning, args.lr, args.l2, config)
