...
from vision_benchmark.evaluation.attention import *
...
def main():
    ...
    # Run attention-tuning
    logging.info('Finetuning with attention-tuning.')
    attentiont(train_dataloader, val_dataloader, test_dataloader, args.no_tuning, args.lr, args.l2, config)
