...
_C.KNOWLEDGE.WIKITIONARY.WIKI_DB_PATH = '/home/chunyl/project/load_wiki'
_C.KNOWLEDGE.WIKITIONARY.PRE_EXTRACTED = False
_C.KNOWLEDGE.WIKITIONARY.WIKI_DICT_PATH = 'resources/knowledge/external' # /home/chunyl/project/Vision-Benchmark-IC/vision_benchmark
...
_C.KNOWLEDGE.AGGREGATION.MEHTOD = 'WIKI_THEN_GPT3' # 'WIKI_AND_GPT3'
...
_C.TRAIN.INIT_HEAD_WITH_LOGIT_SCALE = False # if linear head will be scaled with the logit_scale from the text encoder
