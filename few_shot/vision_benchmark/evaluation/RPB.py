...
class VisionTransformer(nn.Module):
    ...
    def __init__(self,
        ...
        use_cls_tocken = False    ## match RPB size
        if use_cls_tocken:
...
def rpbt(train_dataloader, val_dataloader, test_dataloader, no_hyperparameter_tuning, lr, l2, config):
